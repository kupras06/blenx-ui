...
>): React.ReactElement {
	...
	const inputProps = mergeProps(
		props,
		stylex.props(comboboxStyles.chipsInput, style),
	);
	return (
...
export function ComboboxClear({
	...
	const clearProps = mergeProps(
		props,
		stylex.props(comboboxStyles.adornment, style),
	);
	return (
...
>): React.ReactElement {
	const resolvedSize = size ?? "default";
	const renderSize =
		resolvedSize === "sm" || resolvedSize === "lg" ? resolvedSize : "default";
	const inputProps = mergeProps(
		props,
		stylex.props(
			resolvedSize === "sm"
	...
	const triggerStyleProps = stylex.props(
		...
		resolvedSize === "sm"
			? comboboxStyles.adornmentSm
			: comboboxStyles.adornmentDefault,
		resolvedSize === "sm"
			? comboboxStyles.adornmentEndSm
			: comboboxStyles.adornmentEndDefault,
	...
	const startAddonStyleProps = stylex.props(
		...
		resolvedSize === "sm"
			? comboboxStyles.startAddonSm
			: comboboxStyles.startAddonDefault,
	);
	...
	return (
		<ComboboxPrimitive.Item data-slot="combobox-item" {...itemProps}>
			<ComboboxPrimitive.ItemIndicator
				{...stylex.props(comboboxStyles.itemIndicator)}
			>
...
export function ComboboxSeparator({
	...
	const separatorProps = mergeProps(
		props,
		stylex.props(comboboxStyles.separator, style),
	);
	return (
...
export function ComboboxGroup({
	...
	const groupProps = mergeProps(
		props,
		stylex.props(comboboxStyles.group, style),
	);
...
export function ComboboxGroupLabel({
	...
	const groupLabelProps = mergeProps(
		props,
		stylex.props(comboboxStyles.groupLabel, style),
	);
	return (
...
export function ComboboxEmpty({
	...
	const emptyProps = mergeProps(
		props,
		stylex.props(comboboxStyles.empty, style),
	);
...
export function ComboboxStatus({
	...
	const statusProps = mergeProps(
		props,
		stylex.props(comboboxStyles.status, style),
	);
	return (
		<ComboboxPrimitive.Status data-slot="combobox-status" {...statusProps} />
	);
}
...
export function ComboboxChips({
	...
	const { chipsRef } = React.useContext(ComboboxContext);
	const chipsProps = mergeProps(
		props,
		stylex.props(comboboxStyles.chips, style),
	);
