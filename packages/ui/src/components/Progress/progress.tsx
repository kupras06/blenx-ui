...
function Progress({ children, style, ...props }: ProgressRootProps) {
  return (
    <ProgressPrimitive.Root {...stylex.props(progressStyles.root, style)} {...props}>
      {children ?? (
        <ProgressTrack>
          <ProgressIndicator />
        </ProgressTrack>
...
export function ProgressLabel({ style, ...props }: ProgressLabelProps) {
  return <ProgressPrimitive.Label {...stylex.props(progressStyles.label, style)} {...props} />;
}
...
export function ProgressTrack({ style, ...props }: ProgressTrackProps) {
  return <ProgressPrimitive.Track {...stylex.props(progressStyles.track, style)} {...props} />;
}

type ProgressIndicatorProps = PropsWithStylex<ProgressPrimitive.Indicator.Props>;

export function ProgressIndicator({ style, ...props }: ProgressIndicatorProps) {
  return (
    <ProgressPrimitive.Indicator {...stylex.props(progressStyles.indicator, style)} {...props} />
  );
}
...
export function ProgressValue({ style, ...props }: ProgressValueProps) {
  return <ProgressPrimitive.Value {...stylex.props(progressStyles.value, style)} {...props} />;
}
