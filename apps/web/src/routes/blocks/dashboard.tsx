...
const BLOCKS: BlockInfo[] = [
  {
    ...
    demoExports: ["Dashboard01DefaultDemo"],
  },
  {
    key: "profile-01",
    label: "Profile",
    ...
    demoExports: ["Profile01DefaultDemo"],
  },
  {
    key: "settings-01",
    label: "Settings",
    ...
    demoExports: ["Settings01DefaultDemo"],
  },
];
  ...
  return (
    <VStack gap="large">
      <VStack gap="small">
        ...
        <Text variant="body2" color="secondary">
          Dashboard and profile page blocks — analytics dashboard, user profile, and application
          settings.
        </Text>
      </VStack>
