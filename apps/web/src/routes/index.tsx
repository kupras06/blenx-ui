...
function ShowcaseDialog() {
	return (
		<Dialog>
			<DialogTrigger render={<Button size="small" variant="outline" />}>
				Open Dialog
			</DialogTrigger>
			<DialogContent>
				<DialogHeader>
				...
				<DialogPanel>
					<Text variant="body2">
						This demonstrates a working dialog component using Base UI and
						StyleX.
					</Text>
				</DialogPanel>
				<DialogFooter>
					<HStack gap="small" justify="end" wrap>
						<DialogClose render={<Button size="small" variant="ghost" />}>
							Cancel
						</DialogClose>
		...
		<AccordionRoot defaultValue={["item-1"]}>
			<AccordionItem value="item-1">
				...
				<AccordionPanel>
					<Box padding="small">
						<Text variant="body2" color="secondary">
							A registry-first React component library built with StyleX and
							Base UI.
						</Text>
					</Box>
				</AccordionPanel>
			...
			<VStack gap="xxxlarge">
				...
				<Box maxWidth={640} style={styles.centeredBox}>
					<VStack gap="large" align="center">
						...
						<Alert variant="info" icon={<FileCode size={16} />}>
							<Text variant="body2">
								<strong>No bloated dependency.</strong> No vendor lock-in. No
								runtime styling library.
							</Text>
						</Alert>
					</VStack>
				</Box>
					...
					<VStack gap="small" align="center">
						...
						<Box maxWidth={560} style={styles.centeredBox}>
							...
							>
								...
								customization in mind. All interactive.
							</Text>
						</Box>
					</VStack>
					...
					<VStack gap="large" align="center">
						...
						<Box maxWidth={560} style={styles.centeredBox}>
							<Text
								...
								align="center"
							>
								Stop fighting your component library. Install what you need,
								customize everything, and scale with confidence.
							</Text>
						</Box>
						<HStack gap="medium" wrap justify="center">
							<Button
